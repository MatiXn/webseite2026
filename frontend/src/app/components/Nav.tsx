...
const EMPLOYER_LINK = ["/talente-finden", "Talente finden"] as const;
    ...
    <nav style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
        <Link href="/kontakt" style={{
          fontSize: 14, fontWeight: 500, color: "var(--navy)", textDecoration: "none", opacity: 0.7,
        }}>
          Kontakt
        </Link>
        <Link href={EMPLOYER_LINK[0]} style={{
          fontSize: 14, fontWeight: 700,
          color: pathname === EMPLOYER_LINK[0] ? "#fff" : "var(--navy)",
          background: pathname === EMPLOYER_LINK[0] ? "var(--blue)" : "transparent",
