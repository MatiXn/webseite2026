    ...
    <div style={{ background: "#f5f5f7", minHeight: "100vh" }}>
      ...
      <main style={{ padding: "64px 24px 80px" }}>
        <div style={{ maxWidth: 760, margin: "0 auto", background: "#fff", borderRadius: 28, padding: "48px 56px" }}>
          ...
          <p style={{ fontSize: 15, color: "#707070", marginBottom: 48 }}>Stand: Juni 2026 · Gemäß DSGVO, BDSG und TMG</p>
          ...
          <Section title="5. Ihre Rechte als betroffene Person (Art. 15–22 DSGVO)">
            ...
            <div style={{ marginTop: 16, padding: 20, background: "#f5f5f7", borderRadius: 14 }}>
              <p style={{ fontWeight: 600, color: "#1d1d1f", marginBottom: 8 }}>So stellen Sie einen Antrag:</p>
              <p>
                Per E-Mail an{" "}
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div style={{ marginBottom: 44 }}>
      <h2 style={{ fontSize: 22, fontWeight: 600, color: "#1d1d1f", marginBottom: 14, paddingBottom: 8, borderBottom: "1px solid #d2d2d7" }}>
        {title}
      </h2>
...
const tableStyle: React.CSSProperties = { width: "100%", borderCollapse: "collapse", fontSize: 14, marginTop: 12 };
const thStyle: React.CSSProperties = { padding: "10px 12px", textAlign: "left", fontWeight: 600, color: "#1d1d1f", border: "1px solid #d2d2d7" };
const tdStyle: React.CSSProperties = { padding: "10px 12px", border: "1px solid #d2d2d7", verticalAlign: "top", color: "#1d1d1f" };
