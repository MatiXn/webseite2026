...
const HOME_FAQ = [
  ...
  { q: "Wer zahlt den Personalvermittler bei PHE-Perm Engineering?", a: "Das einstellende Unternehmen zahlt die Vermittlungsprovision an PHE-Perm Engineering – und nur im Erfolgsfall. Für Bewerber entstehen keinerlei Kosten. Dieses Modell ist bei seriösen Personalvermittlern Standard." },
...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* HowTo-Schema entfernt: liefert seit Sept. 2023 kein Rich Result mehr (deprecated) */}
      {/* ── NAV ── */}
      <Nav />
          ...
          <div className="reviews-marquee">
            <div className="reviews-marquee-track">
              {[...REVIEWS, ...REVIEWS].map((r, idx) => (
                // Zweite Marquee-Spur ist reine Animations-Kopie → für Screenreader/Crawler ausblenden
                <div key={idx} className="reviews-marquee-card" aria-hidden={idx >= REVIEWS.length ? "true" : undefined}>
